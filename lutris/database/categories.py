...
def get_game_ids_for_categories(
    included_category_names: Optional[List[str]] = None, excluded_category_names: Optional[List[str]] = None
) -> List[str]:

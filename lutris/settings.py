...
DEFAULT_RESOLUTION_WIDTH = int(sio.read_setting("default_resolution_width") or "1280")
DEFAULT_RESOLUTION_HEIGHT = int(sio.read_setting("default_resolution_height") or "720")

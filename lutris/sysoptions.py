...
system_options = [  # pylint: disable=invalid-name
    ...
    },
    {
        ...
        "type": "bool",
        "default": True,
        "label": _("Separate NVIDIA Shader Cache Location"),
        "advanced": True,
        "help": _("Use a dedicated location for a game's shader cache generated by the NVIDIA driver. "
                  "This bypasses the default shader cache size limitation in the NVIDIA driver and "
                  "avoids unnecessary cache pruning for games with many shaders. "
                  "Disable to use the default (shared) shader cache location. If enabled, this will apply "
